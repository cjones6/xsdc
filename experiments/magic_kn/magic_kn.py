"""
Train a KN on the MAGIC dataset
"""
...
import src.data_loaders.magic as magic

# Parameters for the model, data, and training
parser = argparse.ArgumentParser(description='KN training on the MAGIC dataset')
...
parser.add_argument('--data_path', default='../../data/magic', type=str,
...
parser.add_argument('--save_path', default='../../results/magic_kn/temp', type=str,
...
train_loader, _, train_labeled_loader, train_unlabeled_loader, valid_loader, train_valid_loader, test_loader = \
    magic.get_dataloaders(batch_size=args.batch_size, batch_size_labeled=args.batch_size_labeled,
                          batch_size_unlabeled=args.batch_size_unlabeled, num_labeled=args.num_labeled,
                          balanced=args.balanced, stratified_unlabeling=stratified_unlabeling,
                          data_path=args.data_path, num_workers=0)
